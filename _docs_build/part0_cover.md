...
# Coarse-Graining Genesis Framework V4.0 — Complete Guide

**Symmetry principles · all closed parameters · item-by-item deep reading**

---

**Version**: V4.0 (organised 2026-08-17)
...
**One-sentence summary of the framework**: starting from the spectrum (discrete data) of the internal space RP³, gauge group, geometry, and entropy (continuous structures) emerge through "duality", finally obtaining all the physical quantities of the 4D Standard Model — the only external input is Newton's constant G_N, and the remaining 146 parameters are all closed internally.
